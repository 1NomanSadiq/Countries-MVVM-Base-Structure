...
//    var viewProfileResponse: ProfileResponse? by prefs.objectModel()

    var authToken by prefs.string()
    var isLogin by prefs.boolean()
    var firstName by prefs.string()
    var lastName by prefs.string()
    var userId by prefs.string()
    var profilePicture by prefs.string()
